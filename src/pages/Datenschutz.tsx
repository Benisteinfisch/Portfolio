...
const content = {
  de: {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          'Diese Website nutzt die Schriftarten „Inter" und „Playfair Display". Diese werden lokal vom Server dieser Website ausgeliefert (Self-Hosting). Es wird dabei keine Verbindung zu Servern Dritter (z. B. dem Google Fonts CDN) hergestellt und keine IP-Adresse an Dritte übertragen.',
      },
      {
        h: '5. Lokaler Speicher (localStorage)',
        body:
  ...
  en: {
    ...
    intro: 'Information on the processing of personal data under Art. 13 GDPR',
    sections: [
      {
        h: '1. Controller',
        body: (
      ...
      },
      {
        h: '4. Embedded fonts',
        body:
          'This website uses the "Inter" and "Playfair Display" typefaces. They are served locally from this website\'s own server (self-hosted). No connection to third-party servers (such as the Google Fonts CDN) is established and no IP address is transmitted to third parties.',
      },
      {
        h: '5. Local storage (localStorage)',
        body:
