...
const de: UITranslations = {
  ...
  askBen: {
    open: 'Ask Ben — KI-Assistent öffnen',
    close: 'Chat schließen',
    title: 'Ask Ben',
    subtitle: 'KI-Assistent',
    intro: 'Hi! Ich bin Bens KI-Assistent. Frag mich etwas über seinen Werdegang, seine Projekte oder Fähigkeiten.',
    placeholder: 'Frage zu Bens Profil…',
    send: 'Senden',
    suggestions: ['Was hat Ben studiert?', 'Welche Projekte hat er gemacht?', 'Welche Skills hat er?'],
    error: 'Es gab ein Problem. Bitte versuche es später erneut oder schreib an Ben@Adamo.de.',
    rateLimited: 'Zu viele Anfragen in kurzer Zeit. Bitte versuch es gleich nochmal.',
    notConfigured: 'Der KI-Assistent ist noch nicht aktiviert. Schreib Ben gern direkt: Ben@Adamo.de.',
    disclaimer: 'KI-generiert · kann Fehler enthalten',
    junk: 'Bitte stell eine echte Frage zu Bens Profil. 🙂',
    cooldown: 'Nächste Frage in',
  },
};
...
const en: UITranslations = {
  ...
  askBen: {
    open: 'Ask Ben — open AI assistant',
    close: 'Close chat',
    title: 'Ask Ben',
    subtitle: 'AI assistant',
    intro: "Hi! I'm Ben's AI assistant. Ask me anything about his background, projects or skills.",
    placeholder: "Ask about Ben's profile…",
    send: 'Send',
    suggestions: ['What did Ben study?', 'Which projects has he built?', 'What are his skills?'],
    error: 'Something went wrong. Please try again later or email Ben@Adamo.de.',
    rateLimited: 'Too many requests in a short time. Please try again in a moment.',
    notConfigured: 'The AI assistant is not active yet. Feel free to email Ben directly: Ben@Adamo.de.',
    disclaimer: 'AI-generated · may contain mistakes',
    junk: "Please ask a real question about Ben's profile. 🙂",
    cooldown: 'Next question in',
  },
};
